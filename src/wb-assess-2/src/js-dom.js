...
// const logIn = document.querySelector("#auth").innerText;
...
//     }
// });
let btnText = document.querySelector("#auth").innerText;
btnListener = document.querySelector("#auth");
btnListener.addEventListener("click", change);

function change() 
{

    //code structure coppied from somebody else
    if (btnText.value=="Log in") btnText.value = ("Log out");//old: = "Log out"; //new: = ("Log out");
    // else btnText.value = "log in";
    else btnText.value = ("Log in");
}
console.log(`test`);
